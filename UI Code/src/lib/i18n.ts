...
/** The app languages she can pick. Pashto is shown but marked "soon" until the whole app (and the
 *  teacher) speak it; only a few strings are translated so far. */
export const langOptions = (current: Lang): { v: Lang; label: string; fa?: boolean; soon?: string }[] => [
  { v: "fa", label: "دری", fa: true },
  { v: "ps", label: "پښتو", fa: true, soon: current === "en" ? "soon" : "به زودی" },
  { v: "en", label: "English" },
];
...
export const STRINGS: Dict = {
  ...
  navRights: { en: "My rights", fa: "حقوق من", ps: "زما حقونه" },
